            ...
            >
              ...
              <div className="card-info">
                ...
                <div className="card-actions">
                  <button 
                    className={`heart-button ${likedOutfits[outfit._id] ? 'liked' : ''}`}
                    onClick={(e) => handleHeartClick(e, outfit._id, outfit.title)}
                  >
                    <svg width="20" height="20" viewBox="0 0 24 24" fill={likedOutfits[outfit._id] ? "#db3890" : "none"} stroke="#db3890">
